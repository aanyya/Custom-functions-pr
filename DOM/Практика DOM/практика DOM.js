...
// let elem = document.querySelector('p');
// nums.addEventListener('blur', function(){
...
//     let arr = str.split(' ');
//     for (let i = 0, j = 0; i < arr.length, j < input2.length; i++, j++){
//     input2[j].value = arr[i];
//     } 
// })
...
//     for (let i = 0; i < arr.length; i++){
//         if (arr[i] == arr2[i]){
//             elem.textContent = 'читается';
//         }
//         else{
//             elem.textContent = 'не читается';
//         }
//     }
// })
